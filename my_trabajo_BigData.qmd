...
author:   
  - García Martinez, Jaume (jaugar4@alumni.uv.es)\n 
  - Rubio Rosell, Sara (saruro@alumni.uv.es) \n
  - Sanz Miquel, Isabel (isanzmi@alumni.uv.es)
...
## 3.1 Análisis de la volatilidad inflacionaria por comunidades autónomas
...
tabla_flags <- datos_crisis %>%
  ...
  arrange(desc(Crecimiento_Crisis)) %>% 
